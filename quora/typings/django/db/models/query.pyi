...
import datetime
from typing import Any, Collection, Dict, Generic, Iterable, Iterator, List, MutableMapping, Optional, Reversible, Sequence, Sized, Tuple, Type, Union, overload
...
class _QuerySet(Generic[_T, _Row], Collection[_Row], Reversible[_Row], Sized):
    ...
    def values_list(self, *fields: Union[str, Combinable], flat: bool = ..., named: bool = ...) -> _QuerySet[_T, Any]:
        ...
    
    def dates(self, field_name: str, kind: str, order: str = ...) -> _QuerySet[_T, datetime.date]:
        ...
    
    def datetimes(self, field_name: str, kind: str, order: str = ..., tzinfo: Optional[datetime.tzinfo] = ...) -> _QuerySet[_T, datetime.datetime]:
        ...
    ...
    def extra(self, select: Optional[Dict[str, Any]] = ..., where: Optional[List[str]] = ..., params: Optional[List[Any]] = ..., tables: Optional[List[str]] = ..., order_by: Optional[Sequence[str]] = ..., select_params: Optional[Sequence[Any]] = ...) -> _QuerySet[Any, Any]:
        ...
