...
class Lookup(Generic[_T]):
    ...
    def batch_process_rhs(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, rhs: Optional[OrderedSet] = ...) -> Tuple[List[str], List[str]]:
        ...
    ...
    def process_lhs(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, lhs: Optional[Expression] = ...) -> Tuple[str, List[Union[int, str]]]:
        ...
...
class FieldGetDbPrepValueIterableMixin(FieldGetDbPrepValueMixin):
    ...
    def resolve_expression_parameter(self, compiler: SQLCompiler, connection: BaseDatabaseWrapper, sql: str, param: Any) -> Any:
        ...
