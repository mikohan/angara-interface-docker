...
class Index:
    ...
    def __init__(self, *expressions: Union[BaseExpression, Combinable, str], fields: Sequence[str] = ..., name: Optional[str] = ..., db_tablespace: Optional[str] = ..., opclasses: Sequence[str] = ..., condition: Optional[Q] = ..., include: Optional[Sequence[str]] = ...) -> None:
        ...
